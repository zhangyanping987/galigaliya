    ...
    try {
        ...
        const startPlaying = () => {
            ...
            melody.forEach(([note, duration, sustain]) => {
                ...
                gainNode.gain.linearRampToValueAtTime(0.6, currentTime + 0.05); // 淡入，音量调大
                if (sustain) {
                    gainNode.gain.setValueAtTime(0.6, currentTime + duration - 0.1);
                }
